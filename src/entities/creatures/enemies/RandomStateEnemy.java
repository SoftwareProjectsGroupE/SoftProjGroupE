...
public class RandomStateEnemy extends Enemy {
	...
	public RandomStateEnemy(double health, PVector loc, int radius, double speed, double collision_damage) {
		super(health, loc, radius, speed, collision_damage);
		
		guns[0] = new EnemyAutomatic(30, 0.3, 0.05);
		guns[1] = new EnemyRocketLauncher(60, 0.1);
		guns[2] = new EnemyFlamethrower(0.001, 0.2, 4, 3);
		guns[3] = new EnemyLaser(0.01);
	}
